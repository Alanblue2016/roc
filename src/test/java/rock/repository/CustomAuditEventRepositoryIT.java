package rock.repository;

import rock.RocApp;
import rock.config.Constants;
import rock.config.audit.AuditEventConverter;
import rock.domain.PersistentAuditEvent;
...
import static rock.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
